...
public class T04FindFirstList {
    ...
    @Setup
    public void setUp() {
        intsN100 = IntStream.range(0, N_1MILLION).mapToObj(i -> random.nextInt(MAX_RANDOM))
                .collect(Collectors.toList());
        intsN100.add(200_00_00_000);
        
        List<Integer> intsN50 = IntStream.range(0, N_1MILLION / 2).mapToObj(i -> random.nextInt(MAX_RANDOM))
                .collect(Collectors.toList());
    ...
    public static void main(String[] args) {
        Options options = new OptionsBuilder().include(T04FindFirstList.class.getName()).build();
        new Runner(options);
    }
